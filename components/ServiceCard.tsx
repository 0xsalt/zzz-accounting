...
export function ServiceCard({ title, description, icon }: Service) {
  ...
  return (
    <div className="group rounded-lg border border-border bg-background-secondary p-8 transition-all duration-200 hover:border-accent/40 hover:bg-background-secondary/80">
